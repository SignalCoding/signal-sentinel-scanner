...
[![Version](https://img.shields.io/static/v1?label=version&message=3.0.5&color=blue)](https://github.com/SignalCoding/signal-sentinel-scanner/releases) <!-- x-release-please-version -->
...
docker run --rm ghcr.io/signalcoding/signal-sentinel-scanner:3.0.5 --help
```
