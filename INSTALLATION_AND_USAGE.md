...
```
Signal Sentinel Scanner v3.0.5
```
...
<!-- x-release-please-start-version -->
```bash
docker pull ghcr.io/signalcoding/signal-sentinel-scanner:3.0.5
```
<!-- x-release-please-end -->
...
| Tag | Description |
|-----|-------------|
| `3.0.5` <!-- x-release-please-version --> | Specific version (recommended for CI/CD) |
...
<!-- x-release-please-start-version -->
```bash
docker run --rm ghcr.io/signalcoding/signal-sentinel-scanner:3.0.5 --version
```
<!-- x-release-please-end -->
...
| Image | `ghcr.io/signalcoding/signal-sentinel-scanner:3.0.5` <!-- x-release-please-version --> |
...
docker run --rm \
  ...
  ghcr.io/signalcoding/signal-sentinel-scanner:3.0.5 --discover --skills
```
<!-- x-release-please-end -->
...
docker run --rm \
  ...
  ghcr.io/signalcoding/signal-sentinel-scanner:3.0.5 --config /config/mcp.json
```
<!-- x-release-please-end -->
...
<!-- x-release-please-start-version -->
```bash
docker run --rm ghcr.io/signalcoding/signal-sentinel-scanner:3.0.5 \
...
docker run --rm \
  -v "$HOME/.cursor:/home/sentinel/.cursor:ro" \
  -v "$(pwd):/output" \
  ghcr.io/signalcoding/signal-sentinel-scanner:3.0.5 \
...
*Document generated for Signal Sentinel Scanner v3.0.5* <!-- x-release-please-version -->
