...
```
Signal Sentinel Scanner v3.0.4
```
...
<!-- x-release-please-start-version -->
```bash
docker pull ghcr.io/signalcoding/signal-sentinel-scanner:3.0.4
```
<!-- x-release-please-end -->
...
| Tag | Description |
|-----|-------------|
| `3.0.4` <!-- x-release-please-version --> | Specific version (recommended for CI/CD) |
| `3.0` | Latest 3.0.x patch version |
| `3` | Latest 3.x.x version |
...
<!-- x-release-please-start-version -->
```bash
docker run --rm ghcr.io/signalcoding/signal-sentinel-scanner:3.0.4 --version
```
<!-- x-release-please-end -->
...
| Image | `ghcr.io/signalcoding/signal-sentinel-scanner:3.0.4` <!-- x-release-please-version --> |
...
docker run --rm \
  ...
  ghcr.io/signalcoding/signal-sentinel-scanner:3.0.4 --discover --skills
```
<!-- x-release-please-end -->
...
docker run --rm \
  ...
  ghcr.io/signalcoding/signal-sentinel-scanner:3.0.4 --config /config/mcp.json
```
<!-- x-release-please-end -->
...
<!-- x-release-please-start-version -->
```bash
docker run --rm ghcr.io/signalcoding/signal-sentinel-scanner:3.0.4 \
...
docker run --rm \
  -v "$HOME/.cursor:/home/sentinel/.cursor:ro" \
  -v "$(pwd):/output" \
  ghcr.io/signalcoding/signal-sentinel-scanner:3.0.4 \
...
| SS-026 | ASI01 | Instructional Tool/Skill Description *(v2.4; skill side is frontmatter-only since v3.0)* |
...
*Document generated for Signal Sentinel Scanner v3.0.4* <!-- x-release-please-version -->
