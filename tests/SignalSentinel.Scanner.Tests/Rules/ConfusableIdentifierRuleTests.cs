...
public class ConfusableIdentifierRuleTests
{
    ...
    public async Task CollisionAcrossToolAndSkill_Fires()
    {
        ...
        findings[0].SkillFilePath.ShouldNotBeNull();
        findings[0].ToolName.ShouldBeNull();
        findings[0].McpCode.ShouldBeNull();
    }

    [Fact]
    public async Task StandaloneWholeScriptHomoglyph_Medium()
    {
        ...
        findings[0].Description.ShouldContain("apple");
    }
